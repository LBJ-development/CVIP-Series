...
//		$http.post("http://localhost:8080/series/rest/cases/execute", jsonString).success(function(response, status) {
//            //console.log(response);
//
//            var row= response[0];
//            console.log(row[0]);
//            console.log(new Date(row[1]));
//        })
...
// ADD/REMOVE FIELD OBJECTS ///////////////////////////////////////////////
  ...
  //   				},
		...
		columns		: [{
						...
						template: "<a href='' ng-click='loadSeries(#=series_id#)' >#=series#</a>"
						},{
						field	: "create_dtm",
